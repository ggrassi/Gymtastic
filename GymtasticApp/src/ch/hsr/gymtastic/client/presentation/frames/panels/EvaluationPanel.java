...
public class EvaluationPanel extends JPanel implements Observer {
    ...
    public EvaluationPanel(final SquadController squadController, DeviceType deviceType, ClientFrame frameClient) {
	...
	panelAthleteInfoBorder.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Athlet",
	...
	panelMarksBorder.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Bewertung",
		TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
	...
	if (athlete.getMark(deviceType) != null) {
	    ...
	    txtFieldEMark1.setText("" + athlete.getMark(deviceType).geteMarkOne());
	    txtFieldEMark2.setText("" + athlete.getMark(deviceType).getEmarkTwo());
	    txtFieldEMark3.setText("" + athlete.getMark(deviceType).geteMarkThree());
	    txtFieldBonus.setText("" + athlete.getMark(deviceType).getBonus());
	    txtFieldPenalty.setText("" + athlete.getMark(deviceType).getPenalty());
	} else {
	    initMarkFields();
	}
    }
