...
public class ServerFrame implements Observer {
	...
	tabbedPaneServer.addTab("Ger\u00E4tezuweisung", null, panelDeviceType, null);
	...
	tabbedPaneServer.addTab("Wettkampfverwaltung", null, panelCompetition, null);
	tabbedPaneServer.addTab("Durchgangssteuerung", null, roundAllocation, null);
	tabbedPaneServer.addTab("Athleten", null, panelAthlete, null);
	tabbedPaneServer.addTab("Kampfrichter", null, panelJudge, null);
	tabbedPaneServer.addTab("Ranglistengenerierung", null, panelRanking, null);
