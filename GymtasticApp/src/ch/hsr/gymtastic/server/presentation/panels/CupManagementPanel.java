...
public class CupManagementPanel extends JPanel implements Observer {
	...
	gbl_panelGeneralInfoBorder.rowWeights = new double[] { 0.0, 1.0, Double.MIN_VALUE };
	...
	gbl_panelImport.columnWeights = new double[] { 0.0, 1.0, Double.MIN_VALUE };
	...
	return txtFieldName.getText().equals(gymCupController.getGymCup().getName())
		&& txtAreaDescr.getText().equals(gymCupController.getGymCup().getDescription())
		&& txtAreaSponsors.getText().equals(gymCupController.getGymCup().getSponsors())
		&& (txtFieldStartDate.getText().equals(DateFormatConverter.convertDateToString(gymCupController
			.getGymCup().getStartDate())))
		&& txtFieldEndDate.getText().equals(
			DateFormatConverter.convertDateToString(gymCupController.getGymCup().getEndDate()))
		&& txtFieldLocation.getText().equals(gymCupController.getGymCup().getLocation());
    }
	...
	txtFieldEndDate.setText(DateFormatConverter.convertDateToString(gymCupController.getGymCup().getEndDate()));
	txtFieldStartDate.setText(DateFormatConverter.convertDateToString(gymCupController.getGymCup().getStartDate()));
	...
	GymCup gymCup = db.getEm().find(GymCup.class, gymCupController.getGymCup().getId());
