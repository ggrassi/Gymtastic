...
public class RoundAllocationPanel extends JPanel implements Observer {
	...
	this.competitionController = gymCupController.getCompetitionController();
	...
	btnStartCompetition.addActionListener(new ActionListener() {
		...
		competitionController.setCompetition((Competition) cmbCompetition.getSelectedItem());
	...
	RoundAllocator roundAllocator = competitionController.getRoundAllocator();
	lblFloorStatusText.setText("Bewertet Riege "
		+ roundAllocator.getSquad(DeviceType.FLOOR_EXCERCISE, actualRoundNr));
	lblVaultStatusText.setText("Bewertet Riege " + roundAllocator.getSquad(DeviceType.VAULT, actualRoundNr));
	lblHighBarStatusText.setText("Bewertet Riege " + roundAllocator.getSquad(DeviceType.HIGH_BAR, actualRoundNr));
	lblRingsStatusText.setText("Bewertet Riege " + roundAllocator.getSquad(DeviceType.STILL_RINGS, actualRoundNr));
	lblParallelBarsStatusText.setText("Bewertet Riege "
		+ roundAllocator.getSquad(DeviceType.PARALLEL_BARS, actualRoundNr));
	lblPommelHorseStatusText.setText("Bewertet Riege "
		+ roundAllocator.getSquad(DeviceType.POMMEL_HORSE, actualRoundNr));
	...
	comboBoxCompetitionModel = new CompetitionRoundAllocatorComboBoxModel(gymCupController.getGymCup()
		.getCompetitions());
	...
	lblPommelHorseStatusText = new JLabel("Ger\u00E4tedurchgang nicht gestartet");
	...
	lblParallelBarsStatusText = new JLabel("Ger\u00E4tedurchgang nicht gestartet");
	...
	lblHighBarStatusText = new JLabel("Ger\u00E4tedurchgang nicht gestartet");
