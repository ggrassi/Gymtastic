...
public class RoundAllocationPanel extends JPanel implements Observer {
	...
	private void initGUI() {
		...
		gbc_lblFloorStatusText.insets = new Insets(0, 0, 5, 0);
		...
		gbc_lblPommelHorseStatusText.anchor = GridBagConstraints.WEST;
		gbc_lblPommelHorseStatusText.insets = new Insets(0, 0, 5, 0);
		...
		gbc_lblRingsStatusText.anchor = GridBagConstraints.WEST;
		gbc_lblRingsStatusText.insets = new Insets(0, 0, 5, 0);
	...
	private void updateClientStates() {
		...
		for (DeviceType deviceType : competitionController.getFinishedClients()) {
			...
			case FLOOR_EXCERCISE:
				setState(lblFloorStatusText);
				break;
			case HIGH_BAR:
				setState(lblHighBarStatusText);
				break;
			case PARALLEL_BARS:
				setState(lblParallelBarsStatusText);
				break;
			case POMMEL_HORSE:
				setState(lblPommelHorseStatusText);
				break;
			case STILL_RINGS:
				setState(lblRingsStatusText);
				break;
			case VAULT:
				setState(lblVaultStatusText);
				break;
			}
	...
	private void setState(final JLabel jlabel) {
		EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				jlabel.setText("Bewertung abgeschlossen!");
