...
public class GymCup extends Observable {
	...
	return new GymCupClientInfo(getName(), getLocation(), getStartDate(), getEndDate(), deviceType);
    }

    @Override
    public String toString() {
	return getName() + " in " + getLocation() + " vom " + DateFormatConverter.convertDateToString(getStartDate())
		+ " bis " + DateFormatConverter.convertDateToString(getEndDate());
    }
}
