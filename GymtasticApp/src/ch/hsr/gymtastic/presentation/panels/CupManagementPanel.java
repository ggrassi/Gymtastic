...
public class CupManagementPanel extends JPanel {
	...
	public CupManagementPanel() {
		...
		JPanel panelGeneralInfoBorder = new JPanel();
		panelGeneralInfoBorder.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Allgemeine Infos", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblStartDate = new JLabel("Startdatum:");
		...
		JLabel lblEndDate = new JLabel("Enddatum:");
		...
		JTextArea txtAreaDescr = new JTextArea();
		...
		JLabel lblSponsers = new JLabel("Sponsoren:");
		...
		JTextArea txtAreaSponsers = new JTextArea();
		...
		JPanel panelImportBorder = new JPanel();
		panelImportBorder.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Startlisten Import", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblChoseCup = new JLabel("Datei auswählen");
		...
		JLabel lblStatusCup = new JLabel("status");
		...
		JButton btnOpenCup = new JButton("Cup Öffnen...");
		...
		JLabel lblChoseImport = new JLabel("Datei auswählen");
		...
		JLabel lblStatusImport = new JLabel("status");
		...
		JButton btnImportStartList = new JButton("Importieren...");
		...
		JPanel panelLogoBorder = new JPanel();
		panelLogoBorder.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Logo", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblChoseLogo = new JLabel("Logo auswählen");
