...
public class RankingPanel extends JPanel {
	...
	private void initGUI() {
		...
		panel_2.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Auswahl", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_3.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Liste", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
