...
public class CupManagementPanel extends JPanel implements Observer {
	...
	private boolean nothingChanged() {
		return txtFieldName.getText().equals(
				...
				&& (txtFieldStartDate.getText()
						.equals(convertDateToString(cupManagementModel
	...
	private void updateAfterCancel() {
		...
		txtFieldEndDate.setText(convertDateToString(cupManagementModel
				.getGymCup().getEndDate()));
		txtFieldStartDate.setText(convertDateToString(cupManagementModel
				.getGymCup().getStartDate()));
