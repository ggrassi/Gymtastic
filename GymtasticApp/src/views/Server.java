...
>>>>>>> 3c7a84274fe90e2f0d5186a77ce9eb159c8740d4
	...
	private void initialize() {
		...
		btnAllocateAllDevices.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				clientAllocation.addAllClients(rmiServer.getClientsWaitingForAllocation());
			}
		});
		...
		RoundAllocatoin.add(panelCompetitionControlBorder,
		...
		JComboBox cmbCompetition = cmbDeviceType;
		...
		RoundAllocatoin.add(panelClientStatusBorder,
				gbc_panelClientStatusBorder);
		...
		RoundAllocatoin.add(panelRoundControlBorder,
				gbc_panelRoundControlBorder);
	...
	public static void emulateCup() {
		...
		ImportStartList importList = new ImportStartList(
				"src/importer/Startliste_Bsp.txt");
